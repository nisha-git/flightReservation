...
public class PdfGenerationUtility {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(PdfGenerationUtility.class);
	
	public void generatePdfItinerary(Reservation reservation, String filePath) {
